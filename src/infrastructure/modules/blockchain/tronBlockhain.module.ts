...
@Module({
  ...
  controllers: [],
  providers: [TronMonitorUseCase, TronMonitorService, TronTransactionService, TronInfoService, DepositService, TronEnergyService, ProcessDepositUseCase, ReportService],
